...
//! [`Record`] into your own struct, or read [`Record::ext`] directly.
...
pub trait RecordExt: serde::Serialize + serde::de::DeserializeOwned + Default + Clone {}
impl RecordExt for () {}
...
mod test {
	...
	fn conventional_track_name() {
		assert_eq!(track_name("video0"), "video0.timeline");
	}
}
